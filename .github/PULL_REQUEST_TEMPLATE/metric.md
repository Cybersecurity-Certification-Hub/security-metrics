...
- [ ] The <metric.rego> file is valid according to the [JSON schema](https://github.com/Cybersecurity-Certification-Hub/security-metrics/blob/main/metric_schema.json).
